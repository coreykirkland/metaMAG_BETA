...
BINNING="$MetaMAG"/Binning_Directory
...
Rscript "$LINK"/GF_MAGs.R "$MetaMAG"/"$MG"_MAG_Table.tsv "$MetaMAG"/"$MG"_MAG_Table_Updated.tsv "$LINK"/MetaMAG/PercentTPM.tsv "$MG" "$MAGOutput"
