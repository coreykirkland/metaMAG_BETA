...
echo "###### metaMAG_visualisation_1 module: Updated 20/02/22 ######"
...
# Rscript:
Rscript GenomeVisualisation1.R "$metaMAG"/metaMAG/Genome_Visualisation/Combined_MAGPercentGF1 "$metaMAG"/metaMAG/Genome_Visualisation/Combined_MAGPercentKO1 MAG_Taxonomy.tsv SelectedKOs.tsv AllKOs.tsv "$OUTPUT"
